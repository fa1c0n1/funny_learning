    ...
    public void run() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
           ...
           try {
			...
			//yezq add misc service
            Slog.i(TAG, "PaxMiscService");
			PaxMiscService paxmisc = new PaxMiscService(context,connectivity);
			ServiceManager.addService("PaxMiscService", paxmisc);
            Slog.i(TAG, "PaxMiscService add");
            ...
            int ethOn = Settings.Global.getInt(mContentResolver, Settings.Global.ETHERNET_ON, 0);
            ...
            if (false == FeatureOption.MTK_BSP_PACKAGE && true == FeatureOption.MTK_AUDIO_PROFILES) {
                try {
